...
Shadow and blur tokens compose with the color tokens. Reach for a named shadow rather than a hand-rolled `box-shadow` so elevation stays consistent across surfaces.
