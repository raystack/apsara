...
A meter shows where a value sits in a range. Use it whole, or compose the parts when you need a different arrangement.
...
| Slot | Element |
|------|---------|
| `meter` | The root element |
| `meter-label` | The `Meter.Label` element |
| `meter-value` | The `Meter.Value` element |
