...
The props below cover the shape and size of an avatar, and what it shows when there is no picture to display.
...
One avatar, plus a group for stacking several together.
