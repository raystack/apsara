...
Wraps a submenu root. Use with `Menu.SubTrigger` and `Menu.SubContent` to create nested menus.
...
Use `Menu.SubMenu`, `Menu.SubTrigger`, and `Menu.SubContent` to create nested menus with multiple levels.
