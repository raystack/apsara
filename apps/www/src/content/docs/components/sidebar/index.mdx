...
- Truncation handling
  ...
  - Items whose label is clipped show the full text in a tooltip on hover or focus (positioned away from the sidebar's edge based on `position`; disable with `hideCollapsedItemTooltip`)
