...
<Callout type="attention" highContrast variant="outline">
  DataTable is deprecated and will be removed in a future release. Use [DataView](/docs/components/dataview) instead.
</Callout>
...
<DataTable.Content
  zeroState={
    <Flex direction="column" gap={4} align="center" style={{ padding: "40px" }}>
      <Building2Icon width={48} height={48} style={{ opacity: 0.5 }} />
      <Flex direction="column" gap={2} align="center">
        <Text size="regular" weight="medium">
          No data available
        </Text>
        <Text size='small' style={{ color: "var(--rs-color-text-subtle)" }}>
