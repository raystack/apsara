...
A command menu can sit inline on the page or open in a dialog. Both take the same items.
...
The root, its input and the list beneath it, plus `Dialog` for the overlay form.
