...
settings. See [Theme](/docs/theme/overview).

The component keeps its name but not its props, so migrate the whole
application at once rather than file by file.
...
// After
<Theme value={{ appearance: "dark" }}><Sidebar /></Theme>
