...
export const components = {
  ...
  Description: ({ children, ...props }: any) => {
    ...
    return (
      <Apsara.Paragraph
        ...
        {...props}
        as="p"
        css={{ marginTop: "$2", marginBottom: "$10" }}
      >
        {childText}
      </Apsara.Paragraph>
    );
  ...
  h3: ({ children, id, ...props }: any) => (
    <LinkHeading id={id} css={{ marginTop: "$7", marginBottom: "$1" }}>
      <Apsara.Heading
        ...
        id={id}
        as={"h3" as any}
        css={{ scrollMarginTop: "$9", fontSize: "$6" }}
        data-heading
      >
        {children}
      </Apsara.Heading>
  ...
  p: (props: any) => (
    <Apsara.Paragraph {...props} css={{ marginBottom: "$3" }} as="p" />
  ),
  a: ({ href = "", ...props }) => {
  ...
  hr: (props: any) => (
    <Apsara.Separator size="2" {...props} css={{ my: "$6", mx: "auto" }} />
  ),
  ul: (props: any) => (
    <Apsara.Box
      {...props}
  ...
  ol: (props: any) => (
    <Apsara.Box
      {...props}
      css={{ color: "$hiContrast", marginBottom: "$3" }}
      as="ol"
    />
  ),
  li: (props: any) => (
