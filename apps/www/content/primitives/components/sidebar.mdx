...
<Preview>
  <Sidebar.Root open={true}>
    ...
    <Sidebar.Main>
      ...
      <Sidebar.Item href="#" icon={<InfoCircledIcon />} disabled>
        Settings
      </Sidebar.Item>
    </Sidebar.Main>
    <Sidebar.Footer>
    ...
    <Sidebar.Root open={true}>
      ...
      <Sidebar.Main>
        <Sidebar.Group name="Main">
          ...
          <Sidebar.Item href="#" icon={<InfoCircledIcon />} disabled>Settings</Sidebar.Item>
        </Sidebar.Group>
...
- `name`: string for the group title
- `icon`: Optional ReactNode for group icon
- `children`: ReactNode for the group content
