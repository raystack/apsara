...
<Preview>
  <Flex direction="row" gap="medium">
    ...
    <Chip variant="filled" size="small" color="accent">Accent</Chip>
...
- `color`: Color color (`"neutral"` | `"accent"`, default: "neutral")
  ...
  tabs={[
    {
      ...
      <div style={{ display: 'flex', gap: '10px' }}>
        <Chip variant="outline">Default</Chip>
        <Chip variant="outline" color="accent">Accent</Chip>
  ...
  tabs={[
    {
      ...
      <div style={{ display: 'flex', gap: '10px' }}>
        ...
        <Chip color="neutral" leadingIcon={'O'}>With Icon</Chip>
        <Chip color="neutral" isDismissible>Dismissible</Chip>
      </div>`,
    },
    {
      name: "Accent",
      ...
      <div style={{ display: 'flex', gap: '10px' }}>
        ...
        <Chip color="accent" leadingIcon={'O'}>With Icon</Chip>
        <Chip color="accent" isDismissible>Dismissible</Chip>
      </div>`,
    },
  ]}
/>
