 ...
 * next one is measured, so the hole glides between steps instead of blinking.
 * A disconnected element is skipped (rect frozen at its last good value) rather
 * than collapsed to `0,0`, which would flash the whole screen dim.
 */
...
export function TourOverlay({
  ...
  // just unmounted). Render nothing rather than a full-screen dim with no card.
  if (targeted && (!spotlightElement || !rect)) return null;
