...
/**
 * Renders a tab-based switcher for the configured `views`. Reads `views` and
 * `activeView` from DataView context and writes through `setActiveView`. Renders
 * nothing when `views` is unset or contains a single entry.
 */
