...
export interface TourRootProps {
  ...
  /** A ref to imperative tour controls. */
  ...
  /**
   * Hide the dimmed overlay for the whole tour — only the popover is
   * shown and the page stays fully interactive. Steps can override with
   * `step.disableOverlay`. @default false
   */
  disableOverlay?: boolean;
  /**
   * Tour UI. Defaults to a spotlight backdrop and a popover with the
   * standard layout; compose `Tour.Backdrop` and `Tour.Popover` to
   * customize.
   */
  children?: ReactNode;
}
