...
export interface TableProps<T> {
   ...
   */
  columns: Array<
    ColumnDef<T> & { hidden?: true; filterFn?: RaypointFilterFn<any> }
  >;
...
export type RaypointFilterOption = LiteralUnion<
  string & keyof typeof RaypointFilterFns
>;
export type RaypointFilterFn<TData extends Record<string, any> = {}> =
  | FilterFn<TData>
  | RaypointFilterOption;

export type RaypointAggregationOption = string &
  keyof typeof RaypointAggregationFns;
...
> & {
  ...
  aggregationFn?:
    | RaypointAggregationFn<TData>
    | Array<RaypointAggregationFn<TData>>;
