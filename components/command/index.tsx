...
type CommandPrimitiveInputVariants = VariantProps<typeof CommandPrimitive.Input>;
type CommandInputProps = CommandPrimitiveInputProps & CommandPrimitiveInputVariants & { css?: CSS };
const CommandInput = React.forwardRef<React.ElementRef<typeof CommandPrimitive.Input>, CommandInputProps>(
    ({ className, ...props }, ref) => (
        <Box
            ...
            cmdk-input-wrapper=""
        >
            <MagnifyingGlassIcon style={{ marginRight: "0.5rem", width: "1rem", height: "1rem", opacity: "0.5" }} />
...
type CommandPrimitiveListProps = React.ComponentProps<typeof CommandPrimitive.List>;
type CommandPrimitiveListVariants = VariantProps<typeof CommandPrimitive.List>;
type CommandListProps = CommandPrimitiveListProps & CommandPrimitiveListVariants & { css?: CSS };
const CommandList = React.forwardRef<React.ElementRef<typeof CommandPrimitive.List>, CommandListProps>(
    ({ className, ...props }, ref) => <CommandPrimitive.List ref={ref} {...props} />,
);
...
type CommandPrimitiveEmptyProps = React.ComponentProps<typeof CommandPrimitive.Empty>;
type CommandPrimitiveEmptyVariants = VariantProps<typeof CommandPrimitive.Empty>;
type CommandEmptyProps = CommandPrimitiveEmptyProps & CommandPrimitiveEmptyVariants & { css?: CSS };
...
type CommandPrimitiveGroupProps = React.ComponentProps<typeof CommandPrimitive.Group>;
type CommandPrimitiveGroupVariants = VariantProps<typeof CommandPrimitive.Group>;
type CommandGroupProps = CommandPrimitiveGroupProps & CommandPrimitiveGroupVariants & { css?: CSS };

const CommandGroup = React.forwardRef<React.ElementRef<typeof CommandPrimitive.Group>, CommandGroupProps>(
    ({ className, ...props }, ref) => <StyledCommandPrimitiveGroup ref={ref} {...props} />,
);
...
type CommandPrimitiveSeparatorProps = React.ComponentProps<typeof CommandPrimitive.Separator>;
type CommandPrimitiveSeparatorVariants = VariantProps<typeof CommandPrimitive.Separator>;
type CommandSeparatorProps = CommandPrimitiveSeparatorProps & CommandPrimitiveSeparatorVariants & { css?: CSS };
...
type CommandPrimitiveItemProps = React.ComponentProps<typeof CommandPrimitive.Item>;
type CommandPrimitiveItemVariants = VariantProps<typeof CommandPrimitive.Item>;
type CommandItemProps = CommandPrimitiveItemProps & CommandPrimitiveItemVariants & { css?: CSS };
...
const CommandShortcut = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => {
    return (
        <Text
            css={{ marginLeft: "auto", fontSize: "0.75rem", lineHeight: "1rem", letterSpacing: "0.1em" }}
            {...props}
        />
    );
};
