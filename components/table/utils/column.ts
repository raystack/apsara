...
export const getColumnId = <TData extends Record<string, any> = {}>(columnDef: RaypointColumnDef<TData>): string =>
    columnDef.id ?? columnDef.accessorKey?.toString?.() ?? columnDef.header;

export const getAllLeafColumnDefs = <TData extends Record<string, any> = {}>(columns: RaypointColumnDef<TData>[]) => {
